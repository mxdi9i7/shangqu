<?php include '../partials/head_en.php' ?>
    ...
    <section class="citySection">
        <section class="cityContainer">
            ...
            <div class="cnCityTopBanner">
                
            </div>
            <div class="floatingBtn">
                <a class="btn btn-sm btn-simple btn-simple__blue" id="usCityBtn">U.S. Cities</a>
                <a class="btn btn-sm btn-simple btn-simple__blue" id="cnCityBtn">C.N. Cities</a>
            </div>
            <div class="floatingLinks" id="floatingLinks">
                <ul id="usList">
                    <li>
                        <a id="nytab">New York</a>
                    </li>
                    <li>
                        <a id="dctab">D.C.</a>
                    </li>
                    <li>
                        <a id="matab">Massachusetts</a>
                    </li>
                    <li>
                        <a id="petab">Pennsylvania</a>
                    </li>
                    <li>
                        <a id="fltab">Florida</a>
                    </li>
                    <li>
                        <a id="catab">California</a>
                    </li>
                    <li>
                        <a id="txtab">Texas</a>
                    </li>
                    <li>
                        <a id="aktab">Arkansas</a>
                    </li>
                </ul>
                <ul id="cnList">
                    <li>
                        <a id="gdtab">Guandong</a>
                    </li>
                    <li>
                        <a id="cdtab">Chengdu</a>
                    </li>
                    <li>
                        <a id="shtab">Shanghai</a>
                    </li>
                    <li>
                        <a id="bjtab">Beijing</a>
                    </li>
                    <li>
                        <a id="jstab">Jiangsu</a>
                    </li>
                </ul>
            </div>
            <div class="usCityContent">
                <div class="cityBox ny">
                    ...
                    <img src="../img/shangqu/uscity/nyedu2.png" alt="">
                    <img src="../img/shangqu/uscity/nyedu3.png" alt="">
                    <img src="../img/shangqu/uscity/nyedu4.png" alt="">
            ...
            <div class="cnCityContent">
                 <div class="cityBox gd">
                    ...
                    <a href=https://en.wikipedia.org/wiki/Guangdong"">More info</a>
                    <img src="../img/shangqu/cncity/2.jpg" alt="">
                    <p>
                    ...
                    <img src="../img/shangqu/cncity/3.jpg" alt="">
                    <p>
                ...
                <div class="cityBox cd">
                    ...
                    <img src="../img/shangqu/cncity/8.jpg" alt="">
                    <p>
                    ...
                    <img src="../img/shangqu/cncity/con0.png" alt="">
                    <img src="../img/shangqu/cncity/con1.png" alt="">
                    <p>
                ...
                <div class="cityBox sh">
                    ...
                    <img src="../img/shangqu/cncity/10.jpg" alt="">
                    <p>
...
Shanghai has more than 930 kindergartens, 1,200 primary and 850 middle schools. Over 760,000 middle schools students and 871,000 primary school students are taught by 76,000 and 64,000 teaching staff respectively. 
                    ...
                    <img src="../img/shangqu/cncity/11.jpg" alt="">
                    <p>
...
Shanghai has the largest number of international schools of any city in China. In November 2015 Christopher Cottrell of the Global Times wrote that Shanghai "prides itself on its international schools".
                ...
                <div class="cityBox bj">
                    ...
                    <img src="../img/shangqu/cncity/16.jpg" alt="">
                    <p>
                    ...
                    <img src="../img/shangqu/cncity/14.jpg" alt="">
                    <p>
                ...
                <div class="cityBox js">
                    ...
                    <img src="../img/shangqu/cncity/20.jpg" alt="">
                    <p>
                    ...
                    <img src="../img/shangqu/cncity/18.jpg" alt="">
                    <p>
                    ...
                    <p>
                    As of 2015, Jiangsu hosts 137 institutions of higher education, ranking first of all Chinese provinces. There are two Project 985 and 11 Project 211 universities in the province. A combination of 93 members of Chinese Academy of Sciences and Chinese Academy of Engineering work in Jiangsu. 
...
•	Suzhou University, a Project 211 university
                    ...
                    <img src="../img/shangqu/cncity/19.jpg" alt="">
