...
<input type="text" value="home" hidden id="activeIdentifier">
    ...
    <div class="carousel-inner">
        ...
        <img class="d-block w-100" src="../img/shangqu/c1.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
        <img class="d-block w-100" src="../img/shangqu/c2.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
        <img class="d-block w-100" src="../img/shangqu/c3.jpg" alt="Third slide">
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-3">
                    ...
                    <div class="single-stat text-center">
                        ...
                        <h2 class="single-stat__counter counter">2917</h2>
                        <p>个学生参加</p>
                    </div>
                    <!--/ End Single Count -->
                </div>
                <div class="col-12 col-sm-3">
                    ...
                    <div class="single-stat text-center">
                        ...
                        <h2 class="single-stat__counter counter">75</h2>
                        <p>次集体活动</p>
                    </div>
                    <!--/ End Single Count -->
                </div>
