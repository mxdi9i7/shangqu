    ...
    <section class="schoolSection">
        <section class="schoolContainer">
            ...
            <div class="floatingBtn">
                <a class="btn btn-sm btn-simple btn-simple__blue" id="highBtn">假期赴美知名学府1-4周英语学习定制</a>
                <a class="btn btn-sm btn-simple btn-simple__blue" id="exchangeBtn">小学初中赴美插班生1-4周学习体验</a>
            ...
            <div class="floatingLinks" id="floatingLinks">
                <ul id="exList">
                    <li>
                        <a id="exoverviewtab">项目优势</a>
                    </li>
                    <li>
                        <a id="exschedule">插班生常规参考课程</a>
                    </li>
                    <li>
                ...
                <ul id="highList">
                    <li>
                        <a id="youshitab">项目优势</a>
                    </li>
                    <li>
                        <a id="elementarytab">小学常规课程</a>
                    </li>
                    <li>
                        <a id="middletab">初中常规课程</a>
                    </li>
                    <li>
                        <a id="hightab">高中常规课程</a>
                    </li>
                    <li>
            ...
            <div class="exContent">
                ...
                <div class="schoolBox overviewtab">
                    ...
                    <hr>
                    <p>
                    插班到不同的班级里与美国当地孩子们一起上课，一起学习和生活，我们特别欢迎对数学、计算机、人文学科、历史、设计，美术，科学实验和写作有兴趣的学生加入。
                    </p>
                    <p>
                    本项目整合美国院校及教学研究机构的强力资源，为学生提供优良的教学环境及优秀的师资教学团队，让学生在寓教于乐中感受美国精英教育，培养学生的独立学习意识，对学生未来的学习及升学奠定良好基础，课程结束颁发证书，整个学习过程中中美学生互动学习，感受美国校园文化，融入美式生活。
                    </p>
                </div>
                <div class="schoolBox exschedule">
                    ...
                    <h2>小学插班生常规课程+西班牙语+特色音乐电脑科技课程</h2>
...
NCA (美国教育部区域性认可联盟/North Central Association of Colleges and Schools) 认可之大学；连续多年被US News and World Report杂志评选为美国区域性最优良的大学之一。
                    ...
                    <img src="../img/shangqu/uni/k4.jpg" alt="">
                    <p>
                ...
                <div class="schoolBox youshi">
                    <hr>
                    <h1>项目优势</h1>
                    <h2>英文强化训练，适合小学、初中、高中以及大学生。</h2>
                    <img src="../img/shangqu/c4.png" alt="">
                    <p>
                    由学校老师带领参与不同的学校暑期活动和训练营，丰富课程，纯美式生 活体验，课程为数学、英语、社会科学、科技、口语及写作训练、音乐、美术、物理、化 学等。增加学生在海外学习与实践的经历，开拓国际化视野。不仅能使学生和带队老师亲身体验美国主流社会和学 生生活，组织和领导能力培训和英文强化训练等，还能深入了解美国教育的特点，在实践中培养学生创新意识及组织沟通能力，尚趣通过根据中方和学生的情况和要求，专门设计和组织夏令营的内容，如领导力培训、科技创新、工作实习、留学指南等多种形式的夏令营，使学生们获得最大的收益。
                    </p>
                    <p>
                    可参考学习安排（可根据不同要求在英语听说读写的学习中，加入科技、美术、音乐、演讲、物理、化学等专业课程）
                    </p>
                </div>
